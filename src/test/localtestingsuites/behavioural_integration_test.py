...
class TestAnthropicMessage(unittest.TestCase):
    ...
    @mock_aws
    def test_get_non_sarcastic_anthropic_message(self):
        ...
        self.behavioral_asserter.assert_behavioral_match(result, "A warm and polite birthday greeting to John Doe")
    ...
    @mock_aws
    def test_get_non_sarcastic_openai_message(self):
